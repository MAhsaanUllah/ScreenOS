  ...
  return (
    <div className="max-w-[1400px] mx-auto space-y-6">
      ...
      <div className="relative overflow-hidden rounded-xl border border-slate-200 bg-gradient-to-br from-brand-50 via-white to-slate-50 p-8">
        <div className="absolute top-0 right-0 w-80 h-80 bg-brand-100 rounded-full blur-3xl opacity-30 -translate-y-1/2 translate-x-1/4" />
        <div className="absolute bottom-0 left-0 w-48 h-48 bg-emerald-100 rounded-full blur-3xl opacity-20 translate-y-1/2 -translate-x-1/4" />
